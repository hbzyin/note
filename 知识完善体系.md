...
|序号|名称     |团队           |star指数|包大小(gzip)      |学习曲线|相关技术|相关信息     |
|---|---------|------------  |------:|----------------:|----|---|--------|
|1  |angularjs|谷歌           |56,105+|||陡峭|MVC、双向数据绑定|[官网](https://angularjs.org/) |
|2  |angular  |谷歌           |24,910+|237.41kb/v4.1.3|陡峭|MVC、组件化、Rxjs|[官网](https://angular.io/)  |
|3  |react    |facebook      |68,917+|46.45kb/v15.5.4|适中|MVC、组件化、React+Flux+JSX状态存储|[官网](https://facebook.github.io/react/)|
