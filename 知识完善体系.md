...
|序号|名称     |团队           |star指数|相关技术|相关信息     |
|---|---------|------------  |-----:|---|--------|
|1  |angularjs|谷歌           |56,105+|MVC、双向数据绑定|[官网](https://angularjs.org/) |
|2  |angular  |谷歌           |24,910+|MVC、组件化、rxjs|[官网](https://angular.io/)  |
|3  |react    |facebook      |68,917+|MVC、组件化、flux+react状态存储|[官网](https://facebook.github.io/react/)|
|4  |vue.js   |尤雨溪（国内个人)|56,591+|MVC、组件化、|[官网](https://cn.vuejs.org/)|
### 3.2 css及icon类库
