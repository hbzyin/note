...
|序号|类别              |名称    |作用(范围)              |star|特点|团队|官网|
|---|-----------------|-------|-------------------|----:|---|----|---|
|1  | JS包管理器       |npm     | JavaScript包管理器 |13,284+ | |    |  [官网](https://www.npmjs.com/)|
|2  | JS包管理器       |yarn    | JavaScript包管理器 |26,461+|Facebook| [官网](https://yarnpkg.com/lang/en/)| 
|3  | 前端项目打包压缩  |webpack  | 所有资源          |30,423+|Facebook| [官网](https://webpack.js.org/| 
|4  | 前端项目打包压缩  |gulp     | js、css、html    |26,924+|Facebook| [官网](https://gulpjs.com/)| 
|4  | 前端项目打包压缩  |grunt    | js、css、html    |11,508+|Facebook| [官网](https://gruntjs.com/)| 
|4  | 前端项目打包压缩  |bower    | js、css、html    |15,171+|Facebook| [官网](https://bower.io/)| 
|4  | 前端项目打包压缩  |browserify| js、css、html   |11,201+|Facebook| [官网](http://browserify.org/)| 
